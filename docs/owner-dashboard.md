...
| **Wellness**          | Overview                                                                                           |
| **Tools**             | Image converter (various formats), PDF viewer/editor, documentation,  and other productivity tools |
...
| **Concierge AI** → (All)              | Varies by header (e.g., *Development*: Code Gen, DB Schema, Log Analysis, Add Component, Modify Component, Manage Deps, Create API, Project Enhancer, AI Intelligence Levels; *Settings*: Configuration, Data Sources, Usage, Training)                                                            |
...
- **Development View (Advanced):**
  - **Code Gen:** Generate new code snippets based on prompts
  - **DB Schema:** Read-only viewer for current Drizzle ORM database schema
  - **Log Analysis:** Interface to paste logs and ask AI to find anomalies
  - **Add/Modify Component:** Natural language requests to create or modify React components
  - **Manage Deps:** Request adding or removing npm packages
  - **Create API:** Request new tRPC API procedures
  - **Project Enhancer:** Large textarea for complex, multi-file feature requests
